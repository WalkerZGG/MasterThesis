...
\begin{center}
	...
	\begin{tabular}{ccc}
		...
		\hline
		\begin{minipage}[m]{.3\textwidth}\centering\vspace*{5pt}
			\includegraphics[width=.7\textwidth]{Table1_3}\vspace*{5pt}
		\end{minipage} &
		\begin{minipage}[m]{.5\textwidth}
			\begin{itemize}
		...
		\hline
		\begin{minipage}[m]{.3\textwidth}\centering\vspace*{5pt}
			\includegraphics[width=\textwidth]{Table1_5}\vspace*{5pt}
		\end{minipage} &
		\begin{minipage}[m]{.5\textwidth}
			\begin{itemize}
		...
		\hline
		\begin{minipage}[m]{.3\textwidth}\centering\vspace*{5pt}
			\includegraphics[width=.9\textwidth]{Table1_6}\vspace*{5pt}
		\end{minipage} &
		\begin{minipage}[m]{.5\textwidth}
			\begin{itemize}
